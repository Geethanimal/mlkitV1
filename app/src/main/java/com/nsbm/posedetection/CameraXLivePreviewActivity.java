...
import com.nsbm.posedetection.barcodescanner.BarcodeScannerProcessor;
import com.nsbm.posedetection.facedetector.FaceDetectorProcessor;
import com.nsbm.posedetection.labeldetector.LabelDetectorProcessor;
import com.nsbm.posedetection.objectdetector.ObjectDetectorProcessor;
import com.nsbm.posedetection.posedetector.PoseDetectorProcessor;
import com.nsbm.posedetection.segmenter.SegmenterProcessor;
import com.nsbm.posedetection.facemeshdetector.FaceMeshDetectorProcessor;
import com.nsbm.posedetection.textdetector.TextRecognitionProcessor;
...
import com.nsbm.posedetection.preference.PreferenceUtils;
import com.nsbm.posedetection.preference.SettingsActivity;
            ...
            try {
                switch (selectedModel) {
                    ...
                    case CUSTOM_AUTOML_OBJECT_DETECTION:
                        ...
                        CustomObjectDetectorOptions customAutoMLODTOptions = PreferenceUtils.getCustomObjectDetectorOptionsForLivePreview(this, customAutoMLODTLocalModel);
                    ...
                    case POSE_DETECTION:
                        ...
                        imageProcessor = new PoseDetectorProcessor(this, poseDetectorOptions, shouldShowInFrameLikelihood, visualizeZ, rescaleZ, runClassification,/* isStreamMode = */ true);
                        break;
